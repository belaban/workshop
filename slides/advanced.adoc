...
* Because the invocation rate (5 threads generate 10 invocations/sec) is greater than the delivery rate, RPCs
  keep piling up in `MaxOneThreadPerSender`
...
Lab: advanced 2
---------------
* Change `config.xml`: set `thread_pool.max_threads="10"`
