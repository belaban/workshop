...
Writing a protocol
------------------
* Let's write a simple protocol which prints the number of bytes for each received message to stdout
...
Exposing attributes and operations via JMX
------------------------------------------
* JmxConfiguratror: discuss
