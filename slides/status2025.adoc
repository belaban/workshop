...
* `RELAY3`: M will get retransmitted when the new site master of A (or B) comes up
...
* `hf` - `net1` - `net2` - `net3`
* To send a message from `net3` to `hf`, it has to be forwarded from `net3` to `net2` to `net1` to `hf`
* Configuration:
